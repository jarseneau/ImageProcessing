...
public class PPMImageViewTest {
  ...
  public void testSave() {
    ...
    v.save("tests/viewTests/9pixels.ppm", m);

    ImageProcessingModel m2 = new PPMProcessingModel("tests/viewTests/9pixels.ppm");
  ...
  public void testSaveEdgeCases() {
    ...
    try {
      ImageProcessingModel m2 =
              new PPMProcessingModel("tests/viewTests/fgdaklgadklsg.ppm");
  ...
  public void testRenderMessage() {
    ...
    ImageProcessingView v = new PPMImageView(output);
  ...
  public void testRenderMessageIO() {
    try {
      ...
      ImageProcessingView v = new PPMImageView(o);
